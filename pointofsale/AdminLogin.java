...
public class AdminLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setBackground(new java.awt.Color(42, 130, 199));
        jLabel2.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(42, 130, 199));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 950, 760));
    ...
    private void loginMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loginMouseClicked
        ...
        if (username.getText().equals("admin") && !(username.getText().isEmpty())) {
            if (new String(password.getPassword()).trim().equals("admin123") && !(new String(password.getPassword()).isEmpty())) {
